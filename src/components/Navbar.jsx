...
export default function Navbar() {
    ...
    return (
        <div className="fixed bottom-0 sm:static w-full bg-black flex justify-around p-3 sm:w-fit sm:flex-col sm:justify-normal sm:space-y-7 sm:pt-11 sm:items-center">
