...
export default function Navbar() {
    ...
    return (
        <div className="sticky bottom-0 sm:static w-full flex justify-around p-3 sm:w-fit sm:flex-col sm:justify-normal sm:space-y-7 sm:pt-11 sm:items-center sm:h-full">
